...
module memory_NC#(parameter RAWIDTH = 2,  CAWIDTH = 2) //RAWIDTH=Row Adress Width and CAWIDTH=Column address width
				(
				// Clock and Reset
				input clk,
				input rst,
...
//active NPSF 
always@(memory[1][1] or memory[0][1] or memory[1][0] or memory[1][2] or memory[2][1])
if(memory[0][1]==1 && memory[1][0]==1 && memory[1][2]==1 && memory[2][1]==0)
begin
    memory[1][1]=1;
end

//state coupling fault
always@(memory[1][1] or memory[1][2])
if(memory[1][2]==0)
begin 
    memory[1][1]=0;
end
