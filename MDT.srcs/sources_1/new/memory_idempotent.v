...
module memory_IdC#(parameter RAWIDTH = 2,  CAWIDTH = 2) //RAWIDTH=Row Adress Width and CAWIDTH=Column address width
				(
				// Clock and Reset
				input clk,
				input rst,
...
//Idempotent fault with victim cell address > aggressor cell address
always @(memory[1][2])
begin 
    memory[2][1] = 1;
end
