...
module memory_N#(parameter RAWIDTH = 2,  CAWIDTH = 2) //RAWIDTH=Row Adress Width and CAWIDTH=Column address width
				(
				// Clock and Reset
				input clk,
				input rst,
...
if(memory[0][1]==1 && memory[1][0]==1 && memory[1][2]==0 && memory[2][1]==0)
begin
    memory[1][1]=0;
end
